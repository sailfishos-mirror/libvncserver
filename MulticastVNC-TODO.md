...
- When operating with maxSendRateFixed, actual send rate is much lower.
  The problem shows up at higher transmission rates like 10MB/s. Very
  probably due to the receiver not draining the receive buffer fast enough
  (it all single-threaded as of now).
